...
it('Search engine', () => {
    ...
    .get('._3x17Igk9XRXcaKrcG3_MXQ > .FlyoutMenu-sc-xq6xx0-0 > .ipc-button > .ipc-button__text > #iconContext-arrow-drop-down')
    .click()

    .get('.imdb-header-account-menu__sign-out > .ipc-list-item__text')
    .click()
